...
if (isset($_POST['game']) && isset($_POST['genre'])) {
    ...
    $query = "INSERT INTO games (game, genre, system, why)
    VALUES (?, ?, ?, ?)";
    ...
    echo "New record for " . $game . " entered successfully.";
} else {
